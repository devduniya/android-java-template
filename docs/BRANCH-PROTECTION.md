...
Since a push to `deployment` triggers a real build and spends your
Android signing secrets, consider a lighter rule restricting which
users/teams can push to it directly, even without requiring a full PR.
